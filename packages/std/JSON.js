...
(function () {
  ...
  function str(key, holder) {
    ...
    case 'boolean':
      return String(value);
    case 'object':
      // object, array, date, null
      if (value === null) {
        return 'null';
      }
      // typeof null == 'object'
      if (value.constructor === Date) {
        return exports.stringifyDate(value);
      }
  ...
  exports.stringifyDate = function (d) {
    var year = d.getUTCFullYear(), month = d.getUTCMonth() + 1, day = d.getUTCDate(), hours = d.getUTCHours(), minutes = d.getUTCMinutes(), seconds = d.getUTCSeconds(), ms = d.getUTCMilliseconds();
